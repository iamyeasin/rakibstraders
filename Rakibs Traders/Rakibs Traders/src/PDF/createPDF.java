...
//    static File currentDir = new File("");
    public static final String IMG = cwd + "\\src\\PDF\\Icon.jpg";
    public static final String SRC = cwd + "\\src\\PDF\\Template.pdf";
   
//    public static final String vars = System.getProperty("user.dir") + "";
...
//                    System.err.print ( productTable.getModel().getValueAt(i, j) + " asdfads ");
            ...
            Paragraph comeAgain = new Paragraph("\n\n It is great pleasure doing business with you. Please come again.", smallBold);
